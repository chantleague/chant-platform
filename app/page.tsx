      ...
      <div className="rounded-2xl border border-zinc-800 bg-black/40 p-6">
        <p className="text-[11px] uppercase tracking-[0.2em] text-zinc-400">
          {brand.key === "chantleague"
            ? "CHANT LEAGUE • FOOTBALL ARENA"
            : "BATTLES LEAGUE • PRO ARENA"}
        </p>
        ...
        <p className="mt-2 max-w-2xl text-sm text-zinc-400">
          Domain-based brand routing is ON. You should see the correct brand automatically depending
          on which domain you visit.
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="rounded-2xl border border-zinc-800 bg-black/30 p-5">
          ...
          <div className="mt-1 text-sm text-zinc-400">
            Visit chantleague.com / www.chantleague.com → Chant League UI
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-zinc-800 bg-black/30 p-5">
          ...
          <div className="mt-1 text-sm text-zinc-400">
            Visit battlesleague.com / www.battlesleague.com → Battles League UI
          </div>
        </div>
